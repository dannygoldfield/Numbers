...
| I02 | A number with no valid opening bid remains Scheduled indefinitely; no countdown, resolution, settlement, title, or PublicLand follows from silence. | SE01, SE03 |
| I03 | Canonical records alone determine auction state, economic balances, settlement, and title. | PR01, PR04, RT01, RT04 |
...
| I09 | Resolution, terminal settlement, and title are distinct facts, each fixed by its defined record. Settlement never revises the resolved winner. | RT03–RT05, SE06 |
...
| I11 | Each finalized number has exactly one title: the winning identity after settled, or PublicLand after expired. Title never changes. | RT04 |
| I12 | PublicLand is neither a participant/account nor an error or recovery mechanism. | RT04 |
...
| I16 | One authoritative order and complete atomic groups connect auction, ledger, settlement, and title; unavailable or malformed history is not permission. | PR01–PR06, SE05 |
